...
<%
    ...
    if(userID.equals(bean.getUserID()) == false) {
        session.setAttribute("messageType","오류 메세지");
        session.setAttribute("messageContent","접근할 수 없습니다다");        response.sendRedirect("index.jsp");
        return;
    }
%>
<head>
...
<div class="container">
    <form action="BoardUpdateCon" method="post" enctype="multipart/form-data" >
        <table class="table table-bordered table-hover" style="text-align: center; border: 1px solid #dddddd">
            <thead>
            <tr>
                <th colspan="3"><h4>게시글 수정 양식</h4></th>
            </tr>
            </thead>
            <tbody>
            <tr>
                ...
                <td colspan="2"><h5><%=bean.getUserID()%></h5>
                    ...
                    <input type="hidden" name="boardID" value="<%=bean.getBoardID()%>">
                </td>
            </tr>
            <tr>
                <td style="width: 110px;"><h5>글 제목</h5></td>
                <td colspan="2"><input class="form-control" type="text" name="boardTitle" placeholder="글 제목을 입력하세요" maxlength="50" value="<%=bean.getBoardTitle()%>"></td>
            </tr>
            <tr>
                <td style="width: 110px;"><h5>글 내용</h5></td>
                <td colspan="2"><textarea class="form-control" name="boardContent" id="" placeholder="내용을 입력하세요" maxlength="2048"><%=bean.getBoardContent()%></textarea></td>
            </tr>
            <tr>
                ...
                <td colspan="2">
                    ...
                    <div class="input-group col-xs-12">
                        ...
                        <input type="text" class="form-control input-lg" disabled placeholder="<%=bean.getBoardFile()%>">
