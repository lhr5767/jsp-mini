    ...
    <div class="row">
            ...
            <table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
                ...
                <tr>
                    ...
                    <td colspan="2"><%=bean.getTitle().replaceAll(" ","&nbsp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll("\n","<br>")%></td>
                </tr>
                <tr>
                    <td>작성자</td>
                ...
                <tr>
                    ...
                    <td colspan="2" height="200"><%=bean.getContent().replaceAll(" ","&nbsp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll("\n","<br>")%></td>
                </tr>
                </tbody>
            </table>
        <p>
        ...
        <%
            if(userid != null && bean.getUserid().equals(userid)){
        %>
        <a href="update.jsp?bnum=<%=bnum%>" class="btn btn-primary">수정</a>
        <a onclick="return confirm('정말 삭제하시겠습니까?')" href="deleteBoard.jsp?bnum=<%=bnum%>" class="btn btn-primary">삭제</a>
        <%
            }
        %>
        </p>
