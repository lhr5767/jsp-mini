...
<div class="container">
    <div class="row">
        <form method="post" action="BoardUpdateProCon?bnum=${bean.bnum}">
            <table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
                ...
                <tr>
                    ...
                    <td colspan="2"><input required type="text" name="title" value="${bean.title}"></td>
                </tr>
                <tr>
                    <td>작성자</td>
                ...
                <tr>
                    ...
                    <td colspan="2" height="200"><textarea required name="content"  maxlength="2000">${bean.content}</textarea></td>
                </tr>
                </tbody>
            </table>
